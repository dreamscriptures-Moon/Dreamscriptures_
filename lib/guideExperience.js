...
export function createGuideSchemas({ slug, title, description, faqs = [] }) {
  ...
  const schemas = [
    ...
    { "@context": "https://schema.org", "@type": "Article", headline: title, description, mainEntityOfPage: url, author: { "@type": "Organization", name: "DreamScriptures", url: SITE_URL }, publisher: { "@type": "Organization", name: "DreamScriptures", url: SITE_URL }, dateModified: "2026-07-21" },
  ];
