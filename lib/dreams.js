...
export function getFaqAnswer(field, fallback = "", maxLength = 320) {
  const text = pickFirstText(field, fallback);
  ...
  const faqTemplates = [
    {
      ...
      answer: () =>
        getFaqAnswer(
          pickFirstText(dream.microSummary, dream.shortDescription),
    ...
    },
    {
      ...
      answer: () =>
        getFaqAnswer(
          pickFirstText(dream.emotionalMeaning, dream.emotional),
    ...
    },
    {
      ...
      answer: () =>
        getFaqAnswer(
          pickFirstText(dream.symbolicMeaning, dream.symbolic),
    ...
    },
    {
      ...
      answer: () =>
        getFaqAnswer(
          pickFirstText(dream.wakingLifeMeaning, dream.wakingLife),
...
export function getDreamsBySlugs(slugs = [], dreams = allDreams) {
  ...
  const { slugMap } = getDreamLookup(dreams);
  const seen = new Set();
