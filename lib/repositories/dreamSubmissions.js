...
export async function updateDreamSubmission(id, changes) {
  ...
  if (changes.adminResponse !== undefined) update.admin_response = changes.adminResponse || null;
  ...
  if (changes.replySentAt !== undefined) update.reply_sent_at = changes.replySentAt;
  if (changes.replyEmailId !== undefined) update.reply_email_id = changes.replyEmailId || null;
